from sources import play_agent, start_carla, get_hparams, ConsoleStats, CarlaEnvSettings, get_hparams_abs_addr
import os
from threading import Thread

base_dir='C:\\Users\\Administrator\\Carla-RL-master_pred_ok\\Carla-RL-master'
...
if __name__ == '__main__':
    ...
    hparams = get_hparams_abs_addr(base_dir, playing=True)
