...
class AutoPilot(MapAgent):
    ...
    def _init(self):
        ...
        self._speed_controller = PIDController(K_P=7.0, K_I=0.5, K_D=1.0, n=40)
    ...
    def _get_control(self, target, far_target, tick_data):
        ...
        target_speed = 8.0 if should_slow else 40.0
    ...
    def run_step(self, input_data, timestamp):
        ...
        if self.step % 1000 == 0 and self.save_path is not None:
