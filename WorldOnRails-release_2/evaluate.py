...
def main(args):
    ...
    tm_port = port + 2
    record=args.record
    runner = ChallengeRunner(args, scenario, route, port=port, tm_port=tm_port, record=record)
    runner.run()
...
if __name__ == '__main__':
    ...
    parser.add_argument("--record", type=str, default='', help="path of recording file")
